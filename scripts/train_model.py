...
import os,sys
sys.path.insert(0, "/content/drive/MyDrive/Capstone-Veytel/torchxrayvision/torchxrayvision/")
...
from datasets import PneumoniaXRayDataset

parser = argparse.ArgumentParser()
parser.add_argument('-f', type=str, default="", help='')
parser.add_argument('-name', type=str)
parser.add_argument('--output_dir', type=str, default="/content/drive/MyDrive/Capstone-Veytel/torchxrayvision/output")
...
parser.add_argument('--custom_img_dir', type=str, default="/content/drive/MyDrive/Capstone-Veytel/torchxrayvision/torchxrayvision/data/Sampled_Custom/")
parser.add_argument('--custom_csv_file', type=str, default="/content/drive/MyDrive/Capstone-Veytel/torchxrayvision/torchxrayvision/data/merged_labels.csv")
...
if "custom" in cfg.dataset:
    dataset = xrv.datasets.PneumoniaXRayDataset(
        # csv_file='/content/drive/MyDrive/Capstone-Veytel/torchxrayvision/torchxrayvision/data/merged_labels.csv',
        # img_dir='/content/drive/MyDrive/Capstone-Veytel/torchxrayvision/torchxrayvision/data/Sampled_Custom/',
        csv_file=cfg.custom_csv_file,
        img_dir=cfg.custom_img_dir,
        transform=transforms, data_aug=data_aug)
    datas.append(dataset)
    datas_names.append("custom")
...
if "densenet" in cfg.model:
    ...
    model = xrv.models.DenseNet(num_classes=3, in_channels=1, 
                            **xrv.models.get_densenet_params(cfg.model)) 
